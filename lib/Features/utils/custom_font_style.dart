...
class FontStyle {
  ...
  static final redshade16 = GoogleFonts.lato(
      color: CustomColor.redshadeColor,
      fontWeight: FontWeight.w400,
      fontSize: 16);
  static final redshade17 = GoogleFonts.lato(
      color: CustomColor.redshadeColor,
  ...
  static final greyshadetextw400 = GoogleFonts.poppins(
      color: CustomColor.greyshadewtext,
      fontWeight: FontWeight.w400,
      fontSize: 14);
  static final blackw400 = GoogleFonts.nunitoSans(
      color: CustomColor.blackColor, fontWeight: FontWeight.w400, fontSize: 13);
  static final white8w400 = GoogleFonts.poppins(
