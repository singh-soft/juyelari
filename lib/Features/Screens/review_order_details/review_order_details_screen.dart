...
class ReviewOrderDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //                       child: Center(
      //                         child:!controller.showPaymentSection.value? Text('Continue', style: FontStyle.white18): Text('Pay', style: FontStyle.white18),
      //                       ),
      //                     ),
      //                   ],
      //                 ),
                ...
                children: [
                  ...
                  Obx(() {
                    return !controller.showPaymentSection.value
                        ...
                        :Column(
                          children: [
                            RadioMenuButton(value: true, groupValue: controller.isSelectedPayment.value, onChanged: (value){
                              controller.togglePayment();
                            }, child: Text("Cash On Delivery",style: FontStyle.black16))
                          ],
                        );
                  }),
